...
SCREENING_METRIC_FIELDS = [
    ...
    ("revenue_growth_5y_avg", "Revenue growth (5-year average)"),
    ("earnings_growth_5y_avg", "Net income growth (5-year average)"),
    ("roe_5y_avg", "Return on equity (5-year average)"),
    ("gross_margin_5y_avg", "Gross margin (5-year average)"),
    ("roa", "Return on assets (fraction)"),
    ("roa_5y_avg", "Return on assets (5-year average)"),
