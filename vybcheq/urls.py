...
urlpatterns = [
    ...
    path("rule-sets/save/<slug:slug>/", views_staff.rule_set_save_brief, name="rule_set_save_brief"),
    ...
    path("run-screen/composite/", views_staff.run_screen_composite, name="run_screen_composite"),
    ...
    path("sim/close-security/<int:security_id>/", views_staff.sim_close_security, name="sim_close_security"),
    path("sim/security/<int:security_id>/", views_staff.sim_security_lots, name="sim_security_lots"),
